...
(
    ...
    localparam PAD2 = log2ceil(64'h1044 - 64'h1040); 
    localparam PAD3 = log2ceil(64'h1058 - 64'h1050); 
    ...
    // ( 0x800 .. 0x1000 )
    if ( {address[RG:PAD1],{PAD1{1'b0}}} == 27'h800   ) begin
            src_channel = 6'b000001;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 3;
    end

    // ( 0x1040 .. 0x1044 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 27'h1040   ) begin
    ...
    // ( 0x8000 .. 0xc000 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 27'h8000   ) begin
