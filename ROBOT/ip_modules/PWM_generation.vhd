...
entity PWM_generation is
	port(clk,reset_n:in std_logic;
		 s_writedataR,s_writedataL: in std_logic_vector(13 downto 0);		-- Le bit13 : bit de go(1)/stop(0). 
...
dc_motor_p_L <= '0' when  s_writedataL(13)='1' and s_writedataL(12)='0' else  PWML;
dc_motor_n_L <= '0' when  s_writedataL(13)='1' and s_writedataL(12)='1' else  PWML;				
